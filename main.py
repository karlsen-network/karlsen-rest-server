...
from endpoints import get_balance, get_utxos, get_blocks, get_blockdag, get_circulating_supply, get_karlsend_info, \
...
from helper import get_kls_market_data
...
print(
    ...
    f"{get_karlsend_info}, {get_network}, {get_marketcap}, {get_hashrate}, {get_blockreward}"
